...
<div class="right_col" role="main">         
  ...
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      <div class="x_title">
        <h2>Editing Dependent for {{ $client->name }} {{ $client->surname }}</h2>                    
        <div class="clearfix"></div>
      </div>
      ...
      @include('inc.messages')
        <form data-parsley-validate class="form-horizontal form-label-left input_mask" method="POST" action="{{ route('dependents.update',$dependent->id) }}">
          @csrf
          ...
          <div class="row">
            ...
            <div class="col-sm-3">              
              <div class="item form-group">
                <label class="control-label" for="employer_number">Corporate
                </label>                
                <input id="employer_number" class="form-control" data-validate-length-range="6" readonly="readonly" value="{{!empty($client->group) ? $client->group->name:'No Group' }}" name="employer_number" type="text">                
              </div>  
            </div>
          </div>                   
          </div>
          ...
          <div class="row">  
            <div class="col-sm-6"> 
              <div class="item form-group">
                ...
                <input id="name" class="form-control" data-validate-length-range="6" value="{{ $dependent->name }}" name="name" required="required" type="text">                
              </div> 
            </div>
            <div class="col-sm-6">              
              <div class="item form-group">
                ...
                <input id="surname" class="form-control" data-validate-length-range="6" value="{{ $dependent->surname }}" name="surname" required="required" type="text">                
              </div>  
            </div>
          </div> 
          <hr>         
          <div class="row"> 
            <div class="col-sm-3">              
              <div class="item form-group">
                ...
                <input  class="form-control" id="id_number" value="{{ $dependent->id_number }}" name="id_number" placeholder="eg. 29-12345B66"   type="text">        
              </div>
            </div>
            <div class="col-sm-4">              
              <div class="item form-group">
                ...
                <p>
                  Male:
                  <input title="Male" type="radio" class="flat" name="gender" id="genderM" value="Male" checked="{{ $dependent->gender=='Male' ? 'Checked' : ''}}" required /> 
                  Female:
                  <input type="radio" class="flat" name="gender" id="genderF" value="Female" checked="{{ $dependent->gender=='Female' ? 'Checked' : ''}}" />
                </p>
              </div>
            </div> 
            <div class="col-sm-4">              
              <div class="form-group">
                ...
                <input type="text" id="date_of_birth" name="date_of_birth" value="{{ $dependent->date_of_birth }}" class="form-control"  data-inputmask="'mask': '9999-99-99'">                                 
              </div>
            </div>
