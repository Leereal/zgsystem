  ...
  <div class="">
    <div class="page-title">
      <div class="title_left">
        <h3><strong>Profile : </strong>{{ $client->title }}  {{ $client->name }} {{ $client->surname }} </h3>
      </div>      
    </div>    
    ...
    <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          <div class="x_title">
            <h2>Medical Aid Number : {{ $client->medical_aid_number }} | Plan : {{ $plan->name }}</h2>            
            <div class="clearfix"></div>
          </div>
          <div class="x_content">
            <div class="col-md-3 col-sm-3 col-xs-12 profile_left">
              <div class="profile_img">
                <div id="crop-avatar">
                  <!-- Current avatar -->                  
                  <img class="img-responsive avatar-view" src="@if(!$client->image && $client->gender=='Male'){{asset('images/male.jpg')}} @elseif (!$client->image && $client->gender=='Female'){{asset('images/female.jpg')}} @else {{asset($client->image)}} @endif" alt="Avatar" width="128" height="128" title="Change The Avatar">
                </div>
              </div>
              ...
              <ul class="list-unstyled user_data">
                <li>                  
                  @if(Auth::user()->hasRole(['Service Provider','System Admin']))  
                    <form method="POST" action="{{ route('requestCheckClient',$client->id) }}">                      
                      @csrf
                ...
                <hr>  
                <li><i class="fa fa-map-marker user-profile-icon" data-toggle="tooltip" title="Address"></i> 
                @if(!$client->address)
                  Info not available
                @else
                {{$client->address}}
                ...
                <hr>
                <li>
                  <i class="fa fa-briefcase user-profile-icon" data-toggle="tooltip" title="Business Phone"></i>
                  @if(!$client->business_telephone)
                  Info not available
                  @else
                  {{$client->business_telephone}}
                  @endif 
                </li>
                <hr>
                <li>
                  <i class="fa fa-phone" data-toggle="tooltip" title="Home Phone"></i>
                  @if(!$client->home_telephone)
                  Info not available
                  @else
                 ...
                 <hr>
                <li>
                  <i class="fa fa-envelope" data-toggle="tooltip" title="Email"></i>
                  @if(!$client->email)
                  Info not available
                  @else
                  {{$client->email}}
              ...
              <a href="/clients/{{$client->id}}/edit" class="btn btn-success"><i class="fa fa-edit m-right-xs"></i>Edit Profile</a>
              @endif
              <br />
              ...
              <ul class="list-unstyled user_data">
                <li>
                  <p>Current : 
                    @if($client->period_status=='Stage 5') 
                    Complete!
                    @else
                  ...
                  <div class="progress progress_lg">
                    ...
                    @if($client->period_status=='Stage 1')
                    20
                    @elseif($client->period_status=='Stage 2')
                    40
                    @elseif($client->period_status=='Stage 3')
                    60
                    @elseif($client->period_status=='Stage 4')
                    80
                    @elseif($client->period_status=='Stage 5')
                    100
                    @else
                    0
                    @endif
            ...
            <div class="col-md-9 col-sm-9 col-xs-12">
              ...
              <div class="profile_title">
                ...
                <div class="col-md-6">
                  <div class="pull-right" style="margin-top: 7px;">
                    <p><strong>Joined : {{ $client->created_at }}</strong></p>
                  </div>
                </div>
              </div>
            </br>
              <div class="jumbotron" style="padding: 5px;">
                <ul class="stats-overview">
                  <li>
                    ...
                    <span class="value text-success">{{ $client->membership_status }}</span>
                    @else
                    <span class="value text-danger">{{ $client->membership_status }}</span>
                    @endif
                  </li>
                  <li>
                    <span class="name">Premium</span>                    
                    <span class="badge badge-important">{{ $client->premium}}</span>
                  </li>
                  <li>
                    <span class="name">Total Premium</span>                    
                    <span class="badge badge-important">{{ $client->total_premium }}</span>
                  </li>
                </ul>         
              </div>
              <!-- start of gallery -->
              ...
              <div class="" role="tabpanel" data-example-id="togglable-tabs">
                <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
                  ...
                  <li role="presentation" class="active"><a href="#tab_content1" id="home-tab" role="tab" data-toggle="tab" aria-expanded="true">Limits</a>
                  </li>                  
                  <li role="presentation" class=""><a href="#tab_content2" role="tab" id="profile-tab" data-toggle="tab" aria-expanded="false">Payments</a>
                  </li>
                  @endif
                  <li role="presentation" class=""><a href="#tab_content3" role="tab" id="profile-tab2" data-toggle="tab" aria-expanded="false">Claims</a>
                  </li>
                  <li role="presentation" class=""><a href="#tab_content4" role="tab" id="profile-tab3" data-toggle="tab" aria-expanded="false">Dependents</a>
                  </li>
                </ul>
                    ...
                    <table class="data table table-striped no-margin">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>{{ $claim->serviceprovider->name }}</td>                          
