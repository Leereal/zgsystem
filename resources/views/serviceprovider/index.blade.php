        ...
        <div class="right_col" role="main">         
            ...
            <div class="clearfix"></div>
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Search For Patient to Verify</h2>                    
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                      ...
                      <tbody>
                        @foreach ($clients as $client)
                          <tr>                            
                            ...
                            <td>{{ $client->period_status}}</td>                                            
                            <td>
                              <a onclick="viewInfo({{$client->id}})" class="btn btn-primary btn-xs view_{{$client->id}}" 
                              ><i class="glyphicon glyphicon-eye-open"></i> View Client </a>
                              <a onclick="viewStatement({{$client->id}})" class="btn btn-info btn-xs"><i class="fa fa-folder"></i> More  Details... </a>
                              <a onclick="addForm({{$client->id}})" class="btn btn-primary btn-xs pay_{{$client->id}}" data-name="{{$client->name}}" data-surname="{{$client->surname}}" data-id_number="{{$client->id_number}}" data-medical_aid_number="{{$client->medical_aid_number}}" data-plan_name="{{$client->plan->name}}" data-plan_id="{{$client->plan_id}}"><i class="fa fa-money"></i> Make Payment</a>
                              <form>                               
                                @csrf                                
                              </form>
                            </td>                              
