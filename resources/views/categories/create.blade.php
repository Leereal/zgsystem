                    ...
                    <form class="form-horizontal form-label-left" method="POST" action="{{ route('categories.store') }}">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="name" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" value="{{old('name')}}" name="name" placeholder="e.g Dentist" required="required" type="text">
                        </div>
                      </div> 
